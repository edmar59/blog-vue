    ...
    <div v-for="post in posts" :key="post.id">
      <div class="wrapper">
        <div class="header">
          ...
          <div>
            <button class="del materials-icon" @click="deletePost(post.id)">delete</button>
...
body {
  margin: 0;
  padding: 0;
  background: linear-gradient(135deg, #ffe0b2, #e1bee7); /* peach to lavender */
...
.title-box {
  background: #ffcc80; /* peach orange */
